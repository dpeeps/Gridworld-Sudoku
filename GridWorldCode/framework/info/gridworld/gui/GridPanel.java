        ...
        PseudoInfiniteViewport.Pannable
{
    ...
    private void drawGridlines(Graphics2D g2)
    {
        ...
        g2.drawLine(146, miny, 146, maxy);
        g2.drawLine(293, miny, 293, maxy);
        g2.drawLine(145, miny, 145, miny);
        g2.drawLine(292, miny, 292, maxy);
        
        g2.drawLine(minx, 146, maxx, 146);
        g2.drawLine(minx, 293, maxx, 293);
        g2.drawLine(minx, 145, maxx, 145);
        g2.drawLine(minx, 292, maxx, 292);
    }
